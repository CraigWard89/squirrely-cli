...
export const EDIT_DISPLAY_NAME = 'EditFile';
export const ASK_USER_DISPLAY_NAME = 'Ask User';
export const READ_FILES_DISPLAY_NAME = 'ReadFiles';
export const GLOB_DISPLAY_NAME = 'FindFiles';
export const DIFF_DISPLAY_NAME = 'Diff';
...
export const TOOL_LEGACY_ALIASES: Record<string, string> = {
  ...
  read_file: READ_FILES_TOOL_NAME,
  read_many_files: READ_FILES_TOOL_NAME,
};
